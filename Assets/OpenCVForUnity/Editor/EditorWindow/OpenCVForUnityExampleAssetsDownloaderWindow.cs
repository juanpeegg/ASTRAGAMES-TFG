...
namespace OpenCVForUnity.Editor
{
    ...
    public class OpenCVForUnityExampleAssetsDownloaderWindow : EditorWindow
    {
        ...
        static Dictionary<string, string>[] files = {
            ...
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "HandPoseEstimationExample" }, { "url", "https://github.com/opencv/opencv_zoo/raw/df8b973a5b3dd1cef3d7c84e7edee01aecbaf8bc/models/palm_detection_mediapipe/palm_detection_mediapipe_2022may.onnx" } , { "filename", "palm_detection_mediapipe_2022may.onnx" }, { "sha", "b1020b625429afd3676bd205725b5c1807ad0736" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "HandPoseEstimationExample" }, { "url", "https://github.com/opencv/opencv_zoo/raw/df8b973a5b3dd1cef3d7c84e7edee01aecbaf8bc/models/handpose_estimation_mediapipe/handpose_estimation_mediapipe_2022may.onnx" } , { "filename", "handpose_estimation_mediapipe_2022may.onnx" }, { "sha", "a820983865a11080713e3ccb962e8ddadc9aa6b9" } },
            ...
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "YoloObjectDetectionExample" }, { "url", "https://github.com/pjreddie/darknet/raw/master/data/person.jpg" } , { "filename", "person.jpg" }, { "sha", "19281b65c5bd43381dfe04e637e78d0cf0b05cbe" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "YoloObjectDetectionExample" }, { "url", "https://github.com/AlexeyAB/darknet/raw/master/cfg/yolov4-tiny.cfg" } , { "filename", "yolov4-tiny.cfg" }, { "sha", "b161c2b0984b0c3b466c04b0d6cb3e52f06d93dd" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "YoloObjectDetectionExample" }, { "url", "https://github.com/AlexeyAB/darknet/releases/download/darknet_yolo_v4_pre/yolov4-tiny.weights" } , { "filename", "yolov4-tiny.weights" }, { "sha", "451caaab22fb9831aa1a5ee9b5ba74a35ffa5dcb" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "YoloObjectDetectionExample" }, { "url", "https://github.com/pjreddie/darknet/raw/master/data/coco.names" } , { "filename", "coco.names" }, { "sha", "b769c7d769385f7640be484dd9c7537b6fb2f35e" } },
