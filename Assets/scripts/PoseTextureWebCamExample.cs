...
namespace OpenCVForUnityExample
{
    ...
    public class PoseTextureWebCamExample : MonoBehaviour
    {
        ...
        //Los puntos que se le van a pasar a la red.
        ...
        public ControladorBurbuja controlBurbuja;

        //a cada parte del cuerpo le otorga un entero
        ...
        //cada pareja representa como están relacionados los puntos.
        public string[,] POSE_PAIRS = new string[,] {
        ...
        void Start()
        {
            ...
            controlBurbuja = (ControladorBurbuja)FindObjectOfType(typeof(ControladorBurbuja));
        ...
        void Run()
        {
            ...
            {
                //se lee la red neuronal y se le aplican los puntos.
        ...
        void Update()
        {
            if (webCamTextureToMatHelper.IsPlaying() && webCamTextureToMatHelper.DidUpdateThisFrame())
            {
                ...
                {
                    //Aqui después de estimar están los puntos de detección
                    ...
                    for (int i = 0; i < POSE_PAIRS.GetLength(0); i++)
                    {
                        ...
                        //Dibujo una linea entre ambos puntos y un punto en el lugar.
                        if (points[idFrom] != null && points[idTo] != null && points[idFrom].x != -1 && points[idFrom].y != -1 && points[idTo].x != -1 && points[idTo].y != -1 && esActivo(idFrom,idTo))
                        {
        ...
        bool esActivo(int p1, int p2)
        {
            if(controlBurbuja != null)
                return controlBurbuja.usable(p1) && controlBurbuja.usable(p2);
